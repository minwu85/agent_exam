 ...
 * knowledge, trigger quiz generation) - it cannot reach the database, upload files, or call
 * any other service directly. Each new capability the agent should have starts as a new
 * @Tool method here, not as more logic embedded in a prompt.
 */
@Component
